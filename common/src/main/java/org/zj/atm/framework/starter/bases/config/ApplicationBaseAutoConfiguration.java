package org.zj.atm.framework.starter.bases.config;
...
import org.zj.atm.framework.starter.bases.init.ApplicationContentPostProcessor;
import org.zj.atm.framework.starter.bases.safa.FastJsonSafeMode;
...
public class ApplicationBaseAutoConfiguration {
    ...
    @Bean
    // 修饰bean的一个注解，主要实现的是，当你的bean被注册之后，如果而注册相同类型的bean，就不会成功，它会保证你的bean只有一个，即你的实例只有一个
